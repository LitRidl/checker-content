...
u'''
Составить алгоритм декрементирования целого неотрицательного шестнадцатеричного числа.
Входное слово представляет собой целое неотрицательное шестнадцатеричное число (возможно, с ведущими нулями).
шестнадцатеричное число, результат уменьшения на единицу исходного числа
DEADBEEF
'''
